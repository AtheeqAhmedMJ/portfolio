...
import VideoEditingSection from '../../components/OtherWorksComponents/VideoEditingSection/VideoEditingSection';
import GraphicDesignSection from '../../components/OtherWorksComponents/GraphicDesignSection/GraphicDesignSection';
import DocumentationSection from '../../components/OtherWorksComponents/DocumentationSection/DocumentationSection';
import CreditsSection from '../../components/OtherWorksComponents/CreditsSection/CreditsSection';
...
const OptimizedEffects = () => (
  <EffectComposer resolutionScale={0.85} multisampling={0}>
...
useGLTF.preload('/models/Imperial_Ship_optimized.glb');
